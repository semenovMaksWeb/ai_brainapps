...
class ImageService1:
    ...
    def getGrayImagesPosition(url_image_find = None, url_image_from = None):
        findImage, fromImage = ImageService1._getImageCheck(url_image_find,url_image_from)        
        return ImageService1._getPositionImage(findImage, fromImage)
    ...
    def getImages(url_image_find = None, url_image_from = None, path_save = None):
        findImage, fromImage = ImageService1._getImageCheck(url_image_find,url_image_from,)
        positon = ImageService1._getPositionImage(findImage, fromImage)
